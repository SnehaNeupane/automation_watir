...
env_setting= env_setting1['alpha_prior_slow_validation_cr']
...
diff = diff.round(3)
if diff == 0.001
	browser.Puts "Passed: algorithm works fine for alpha prior slow "
else
	browser.Puts "Failed: algorithm doesn't works fine for alpha prior slow"
end
browser.close
