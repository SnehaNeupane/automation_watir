...
if associate_users_assigned == 'set'
		...
		if flag
			...
			browser.fill_input_text_by_class_index(5,'form-control', prod_usr_name) # Searching your own user name in 1st account to verify the assigned account is displayed
			browser.press_enter
			table_value = browser.get_value_table_withindexandid(1,1)
				if table_value == prod_usr_name 
					...
					#browser.fill_input_text_by_class_index(4, 'form-control', prod_usr_name) # Searching your own user name in 1st account to verify the assigned account is displayed
