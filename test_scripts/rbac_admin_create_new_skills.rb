...
if create_new_skills == 'set'
		...
		if flag
			...
			browser.click_text_field_user('/admin/skills','//*[@id="skill_box_wrap"]/div/form/fieldset/div[3]/input') # clicks on the Add button/image/lins
			# browser.fill_input_text_by_class('span2', add_skill)
			browser.index_fill_input_text(3,add_skill)
			browser.press_enter
