...
if edit_accounts_assigned == 'set'
		...
		if flag
			...
			browser.index_fill_input_text(5,prod_usr_name)
			browser.press_enter
			...
			table_value = browser.get_value_table_withindexandid(1,1)
				...
				if view_accounts_all == 'set'
						browser.click_link_by_href('/admin/accounts')
						browser.index_fill_input_text(2,account_not_exist)
						...
						#browser.fill_input_text_by_class_index(1, 'span2', 'username_cf')
						browser.index_fill_input_text(5,username_cf)
						#browser.index_fill_input_text(2,username_cf) # Searching your own user name in 1st account to verify the assigned account is displayed
						browser.press_enter
				
						table_value = browser.lastday_method_table(1)
						if table_value == prod_usr_name
