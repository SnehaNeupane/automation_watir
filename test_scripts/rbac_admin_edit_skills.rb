	...
	if flag
		...
		flag = browser.find_text_field_user('/admin/skills/46','//*[@id="fancybox-inner"]/div/form/fieldset/p[3]/input')
			if flag 
				...
				browser.click_link_by_xpath('//*[@id="skill_data_table"]/tbody/tr/td[1]/a')
				...
				browser.click_text_field_user('/admin/skills/46/edit','//*[@id="skill_data_table"]/tbody/tr/td[1]/a')
				#'//*[@id="fancybox-inner"]/div/form/fieldset/p[3]/input') # clicks on the Add button/image/lins
			#//*[@id="skill_data_table"]/tbody/tr/td[1]/a
				browser.fill_input_text_by_class('span2', add_skill)
				browser.press_enter	
