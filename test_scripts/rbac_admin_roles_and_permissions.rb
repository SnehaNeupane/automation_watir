...
if manage_roles_and_permissions == 'clear'
  ...
  sleep 10
    ...
    # flag = browser.find_link_by_xpath('/html/body/div[3]/aside[1]/section/ul/li[1]/a').exists?
    # flag = browser.find_link_by_xpath('/html/body/div[3]/aside[1]/section/ul/li[3]/a').exists?
    # flag = browser.find_link_by_href('/admin/roles').exists?
    flag = browser.find_link_by_text('Roles').exists?
    if flag
