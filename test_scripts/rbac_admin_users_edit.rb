...
if edit_users == 'set'
    ...
    if view_users== 'clear'
      ...
      # //*[@id="user_table_filter"]/div/input
      # browser.fill_input_text_by_name('',usr)
      #browser.fill_input_text_by_class('form-control',usr) 
      browser.fill_text_field_by_xpath('//*[@id="user_table_filter"]/div/input',usr)
      # browser.fill_input_text_by_id('user_table_filter', usr)
      # browser.fill_input_in_div_class_by_class('input-group','form-control',usr)
    ...
    browser.button_click_class('btn btn-primary btn-mini')
