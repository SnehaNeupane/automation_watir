...
env_setting= env_setting1['testing_for_review_census_person_III']
###          ####             ####                 ####
...
fourthpass = env_setting['fifthpass']

fifthreviewer = env_setting['fifthreviewer']
fifthpass = env_setting['fourthpass']
...
IICycleReviewer3 = env_setting['IICycleReviewer3']
 IICycleReviewPass3 = env_setting['IICycleReviewPass3'] 

 IICycleReviewer4 = env_setting['IICycleReviewer4'] 
 IICycleReviewPass4 = env_setting['IICycleReviewPass4']  

 IICycleReviewer5 = env_setting['IICycleReviewer5'] 
 IICycleReviewPass5 = env_setting['IICycleReviewPass5']  
...
####Calculating the first reviewer's amount before doing tasks############
...
if flag
	...
	#browser.click_txt_field_frame_name('work_frame', 'Year') # commented for Plus
	browser.click_txt_field_frame_name('work_frame', 'Month') ## for Minus
...
if taskexist
	...
	puts "Worked on gold standard  fourthreviewer, Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
############################ Flagged   Review   #############
browser.fill_input_text_by_name('worker[email]', fifthreviewer )
browser.fill_input_text_by_name('worker[password]', fifthpass)
browser.button_click_name('commit')
...
####Calculating Flagged review worker's amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
if taskexist
	...
	puts "Worked on gold standard  Fifth reviewer, Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for Flagged reviewreviewer 5"
	...
	#####Calulating the 5th worker's amount after doing tasks#####
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
	toint2 = amount3.to_f
...
####Calculating Second Cycle content amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
####Calculating IICycleReviewer1 amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
if taskexist
	...
	puts "Worked on gold standard  IICycleReviewer1 , Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for IICycleReviewer1"
	...
	browser.button_click_frame_name('work_frame', "Submit (Press Enter)")
	sleep 4
	#####Calulating the IICycleReviewer1 amount after doing tasks#####
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
	toint2 = amount3.to_f
...
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass2)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists?
	puts "notification displayed"
	browser.click_span_class('icon-remove remove_notification')
...
####Calculating IICycleReviewer2 amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
if taskexist
	...
	puts "Worked on gold standard  IICycleReviewer2 , Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for IICycleReviewer2"
	sleep 3
	#browser.click_txt_field_frame_name('work_frame', 'Year')
	browser.click_txt_field_frame_name('work_frame', 'Month')
	browser.button_click_frame_name('work_frame', "Submit (Press Enter)")
	sleep 4
	#####Calulating the IICycleReviewer2 amount after doing tasks#####
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
	toint2 = amount3.to_f
...
browser.fill_input_text_by_name('worker[email]', IICycleReviewer3)
...
####Calculating IICycleReviewer3 amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
if taskexist
	...
	puts "Worked on gold standard  IICycleReviewer3, Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for IICycleReviewer3"
	sleep 3
	browser.click_txt_field_frame_name('work_frame', 'Year')
	#browser.click_txt_field_frame_name('work_frame', 'Month')
	browser.button_click_frame_name('work_frame', "Submit (Press Enter)")
	sleep 4
	#####Calulating the IICycleReviewer3 amount after doing tasks#####
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
	toint2 = amount3.to_f
...
browser.fill_input_text_by_name('worker[email]', IICycleReviewer4)
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass2)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists?
	puts "notification displayed"
...
####Calculating IICycleReviewer4 amount before doing tasks############
sleep 1
browser.click_ul_class
browser.click_link_by_text('Account')
amount2 = browser.getValue_span_class('formatted_money').delete("$")
...
if taskexist
	...
	puts "Worked on gold standard  IICycleReviewer4, Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for IICycleReviewer4"
	...
	browser.button_click_frame_name('work_frame', "Submit (Press Enter)")
	sleep 4
	#####Calulating the IICycleReviewer4 amount after doing tasks#####
	browser.click_ul_class
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
...
sleep 100
#############################IICycleReviewer5##################
browser.fill_input_text_by_name('worker[email]', IICycleReviewer5)
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass2)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists?
	puts "notification displayed"
...
if taskexist
	...
	puts "Worked on gold standard  IICycleReviewer5, Passed"
	sleep 5
	flag = browser.find_image_src('work_frame','http://cfaccusoft.s3.amazonaws.com/full/2314ac82-47a3-4d34-9d22-9b0e0ed1970e_Age1.jpg').exists?
	sleep 3
	end
...
flag = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if flag
	puts "Got Regular Tasks for IICycleReviewer5"
	sleep 3
	browser.click_txt_field_frame_name('work_frame', 'Year')
	#browser.click_txt_field_frame_name('work_frame', 'Month')
	browser.button_click_frame_name('work_frame', "Submit (Press Enter)")
	sleep 4
	#####Calulating the IICycleReviewer5 amount after doing tasks#####
	browser.click_ul_class
	browser.click_link_by_text('Account')
	amount3 = browser.getValue_span_class('formatted_money').delete("$")
	toint2 = amount3.to_f
