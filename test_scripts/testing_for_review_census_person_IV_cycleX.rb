...
fifthpass = env_setting['fifthpass']
...
task_exists = browser.find_button_frame_name('work_frame', "Submit (Press Enter)").exists?
if task_exists
...
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass3)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists
	puts "notification displayed"
	browser.click_span_class('icon-remove remove_notification')
...
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass4)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists
	puts "notification displayed"
	browser.click_span_class('icon-remove remove_notification')
...
browser.fill_input_text_by_name('worker[password]',  IICycleReviewPass5)
browser.button_click_name('commit')
if browser.find_span_class('icon-remove remove_notification').exists
	puts "notification displayed"
	browser.click_span_class('icon-remove remove_notification')
